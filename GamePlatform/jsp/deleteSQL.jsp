...
<%
    ...
    try {
        ...
        int reviewAffected = pstmt.executeUpdate();
        pstmt.close();
        ...
        pstmt.setInt(1, Integer.parseInt(id));
        int genreAffected = pstmt.executeUpdate();
        pstmt.close();
        ...
        pstmt.setInt(1, Integer.parseInt(id));
        int purchaseAffected = pstmt.executeUpdate();
        pstmt.close();
        ...
        pstmt.setInt(1, Integer.parseInt(id));
        int gameAffected = pstmt.executeUpdate();
