    ...
    <%
      ...
      try {
        ...
        while(rs.next()) {
          ...
          out.println("<div style=\"left: 736px; top: 256px; position: absolute; color: black; font-size: 24px; font-family: Inter; font-weight: 500; line-height: 33.60px; word-wrap: break-word\">출시일 "+ rs.getString("개발사명") +"</div>");
