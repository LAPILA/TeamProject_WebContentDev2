    ...
    <%
      ...
      try {
        ...
        while(rs.next()) {
          ...
          out.println("<button type=""button"" onclick=""location.href='buy.jsp' style=\"width: 963px; height: 300px; left:" + leftPosition + "; top:" + topPosition + "; position: absolute; border: none; background-size: cover; background-color: transparent; cursor: pointer;\">");
