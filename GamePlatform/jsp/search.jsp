...
<body style="width: 1440px; height: 1024px; position: relative; font-family: 'Roboto'" class="my_div my_bg">
    ...
    <div id="message" style="width: 500px; height: 36px; left: 300px; top: 270px; position: absolute; color: black; font-size: 30px; font-family: 'Roboto', sans-serif; font-weight: 500; line-height: 42px; word-wrap: break-word"></div>
    ...
    <%
        ...
        try {
            ...
            resultMessage.append("Search Results for: ").append(searchQuery);
    ...
    %>
                    <script type="text/javascript">
                        var message = "<%= rs.getString("게임명") %>";
                        document.getElementById("message").innerText = message;
                    </script>
    <%
                }
                out.println("<div style='width: 1275px; height: 200px; margin: 15px auto; position: relative; opacity: 0.85; background: #DFD1E2; border-radius: 8px;'>");
                out.println("<button style='width: 630px; height: 200px; position: absolute; border: none; background-size: cover; background-color: transparent; cursor: pointer;'>"
                        + "<div style='width: 630px; height: 200px; left: 0px; top: 0px; position: absolute; opacity: 0.50; background: white; border-radius: 8px'></div>"
                        + "<div style='left: 203px; top: 20px; position: absolute; text-align: center; color: black; font-size: 24px; font-family: Inter; font-weight: 500; line-height: 33.60px; word-wrap: break-word'>" + rs.getString("게임명") + "<br/></div>"
                        + "<div style='left: 204px; top: 100px; position: absolute; color: black; font-size: 24px; font-family: Inter; font-weight: 500; line-height: 33.60px; word-wrap: break-word; text-align: left;'>" + rs.getString("가격") + "</div>"
                        + "<div style='left: 203px; top: 57px; position: absolute; text-align: center; color: black; font-size: 24px; font-family: Inter; font-weight: 500; line-height: 33.60px; word-wrap: break-word'>" + rs.getString("연령등급") + "</div>"
                        + "<img style='width: 160px; height: 160px; left: 26px; top: 20px; position: absolute' src='" + rs.getString("이미지URL") + "' />"
                        + "</button>");
                out.println("</div>");
            ...
            if (resultCount == 0) {
                out.println("<div style='width: 1275px; height: 200px; margin: 15px auto; position: relative; opacity: 0.85; background: #DFD1E2; border-radius: 8px; text-align: center; line-height: 200px;'>No Results Found</div>");
            }
