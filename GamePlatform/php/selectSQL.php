...
<?php 
	...
	while ($rs.next()) {
		echo "<div class='game-info'>"."<strong>게임 제목:</strong> ".$rs.getString("게임명")."<br><strong>가격:</strong> ".$rs.getFloat("가격")."<br><strong>출시일:</strong> ".$rs.getDate("출시일").toString()."<br><img src='".$rs.getString("이미지URL")."'>"."</div>";
	}
