...
<%
    ...
    String developerId = request.getParameter("developer_id"); // 개발사 ID를 받습니다.
    String price = request.getParameter("price");
    String genre = request.getParameter("genre"); // 장르는 추가 처리가 필요할 수 있습니다.
    ...
    try {
        ...
        String sql = "INSERT INTO 게임 (게임명, 가격, 개발사ID, 시스템사양, 연령등급, 출시일, 이미지URL) VALUES (?, ?, ?, ?, ?, ?, ?)";
        pstmt = con.prepareStatement(sql);
        pstmt.setString(1, gameName);
        pstmt.setFloat(2, Float.parseFloat(price));
        pstmt.setInt(3, Integer.parseInt(developerId)); // 개발사 ID
        // 장르와 시스템 사양, 연령등급은 추가 정보에 따라 적절한 값으로 설정해야 할 수 있습니다.
        pstmt.setString(4, "시스템사양 정보"); // 임시 값
        pstmt.setString(5, "연령등급 정보"); // 임시 값
